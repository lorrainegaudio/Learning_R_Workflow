...
To begin the Wildfire guided activity, follow these steps:

1. Open your course project in RStudio.

   If you **have GitHub** and a course project, open your course project in RStudio. Click **Pull** in the Git pane to get the latest version of the course materials. After completing your work, save, stage, commit, and push.
...
3. Download the data file: <a href="/data/wildfire/whp_raw_sample.csv" download>whp_raw_sample.csv</a>

   Save `whp_raw_sample.csv` in the same course folder as `Fire-Assignment-PartA-StudentCopy.qmd`.

4. Open `Fire-Assignment-PartA-StudentCopy.qmd` in RStudio.

5. Edit the YAML to show your name.

6. Follow along with the guided activity.
...
if (!file.exists(whp_path)) {
  stop(
    "Cannot find wildfire raster file:\n",
    whp_path,
