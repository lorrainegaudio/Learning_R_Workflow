...
![Figure 2. Tools menu is selected and Global Options is at the bottom of the list](/assets/images/ch09-github/Tools_Global Options.png)
...
![Figure 3. Git/SVN option item shows version control settings.](/assets/images/ch09-github/Tools_Global Options_VersionControl.png)
...
![Figure 4. Screenshot of both the Terminal pane and the Git/SVN option window in Global Options.](/assets/images/ch09-github/check_for_git.png) 
...
![Figure 5. git --version output examples](/assets/images/ch09-github/git_not_installed_error.png)
...
## Checkpoint: Do You Need to Install Git?
...
## Checkpoint: RStudio Terminal Check
...
![Figure 5. screenshot of a Git introduction.](/assets/images/ch09-github/git_identity.png)
...
**Clone** means copy a GitHub repository onto your computer. RStudio will create a new project folder from the GitHub repository.
...
🎯 Create the project as a **subdirectory** by selecting choose your course folder. For example: `DATA-R155/`
...
A **local change** is a change you make on your own computer. In this section, you will edit the `README` file in RStudio, commit the change, push it to GitHub, and confirm that GitHub received it.

## Step 1

**Open `README.md`**

🎯 In the RStudio Files pane, click:
...
🗣 Staging means, “include this file in the next commit.”
...
🗣 Push sends your local commit from RStudio up to GitHub.
...
**Pull** means to grab changes from GitHub and bring them into your local project. Pulling is like saying, “What’s new on GitHub since I last worked?” If you are the only person using the repository, you will likely see "Already up to date." when you pull. That is normal. It means there are no new changes on GitHub that you don't have locally.
...
A data folder (**`data\`**) is a folder where project data files are stored. A **`.gitignore`** file tells Git which files or folders to ignore when committing changes.
...
✅ Verify that the d`ata/ `folder appears in your Files pane.
...
![Figure 1. Diagram of the folder structure on your computer and your GitHub Repository](/assets/images/ch09-github/Folder_Structure.png)
