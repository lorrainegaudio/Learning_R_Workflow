...
### How to read folder structure diagrams 
...
## Create/Save Chapter 7 Notebook
...
### Need help moving the downloaded files?
...
knitr::include_graphics("/assets/images/ch07-importing/getwd_in_console.png")
```
...
![Click the 📥 Install button from the Packages tab then type `dslabs` in the Packages box and click Install to download dslabs from the Package Repository CRAN](/assets/images/ch07-importing/Packages.png)
